...
local function validateKey(key)
    return key == "AtsuageZSubscribe" -- Replace this with your key
end
...
loadstring(game:HttpGet(("https://raw.githubusercontent.com/atsuage333/AtsuageZHUB/main/main/loader.lua")))()
